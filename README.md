...
Hermes Agent Desktop Plugin that hides the built-in, non-toggleable status-bar controls:
...
This is a **Hermes Agent Desktop Plugin**. Do not install it in the remote Gateway's LXC.
